...
public class UserWriter implements ItemWriter<User> {
  ...
  public void write(List<? extends User> list) throws Exception {
    list.forEach(user -> {
      ...
      simpleMailMessage.setText("Dear " + user.getLastName()
          + ", you receiving this message because your balance is low.");

      javaMailSender.send(simpleMailMessage);

      logger.debug(
          "Message to " + user.getFirstName() + " " + user.getLastName() + ", email address: "
